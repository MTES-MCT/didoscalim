...
#' @param date_diffusion (optionnel) la date la date/heure à laquelle le fichier
...
#'   dataset = dataset,
#'   title = "titre embargo",
#'   description = "description embargo",
#'   file_name = dido_example("augmente.csv"),
#'   temporal_coverage_start = "2021-01-01",
#'   temporal_coverage_end = "2021-12-31",
#'   legal_notice = "something",
#'   millesime = "2020-10",
#'   date_diffusion = "2023-01-01 05:00:00"
#' )
add_datafile <- function(dataset,
                         ...
                         legal_notice = "SDES",
                         date_diffusion = format(Sys.time(), "%Y-%m-%d 00:00:00"),
                         quiet = NULL) {
