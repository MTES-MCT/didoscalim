...
Générer un fichier CSV augmenté à partir d'un fichier CSV normal et le charger
dans un dataset.
...
documentation nécessaire dans la vignette [utiliser les
...
* [comment générer un fichier augmenté](https://mtes-mct.github.io/didoscalim/articles/csv-augmente.html)
...
* [utiliser les environnements](https://mtes-mct.github.io/didoscalim/articles/les-environnements.html)
...
Pour gagner du temps vous pouvez lancer séparément les tests unitaires et de
couverture :
...
faut donc pour le moment générer le site statiquement à partir d'un poste qui a
...
en lançant `populate.R` puis la commande qui publiera le site sur les github
pages :
